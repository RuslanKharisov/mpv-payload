        ...
        columns: [
          {
            ...
            enableLink: false,
            richText: createRichText([
              // --- ДОБАВЛЕНЫ ЗАГОЛОВОК И ДАТЫ ИЗ ИСТОЧНИКА ---
              createHeading('h1', 'Инструкция по настройке API Google Таблицы'),
              createParagraph('Создано: 01.03.2025'),
              createParagraph('Обновлено: 01.04.2025'),
              ...
              createParagraph('Пример таблицы и файла скрипта:'),
              createParagraph([
                createText('👉 '),
              ...
              createParagraph([
                // Добавил пробелы для имитации отступа из исходника
                createText('                                                  после /d/ '),
              ...
              // --- ИСПРАВЛЕНА СТРУКТУРА ДЛЯ ПОДПУНКТОВ ---
              createParagraph('Заполните:'),
              createList([
                'Описание: API',
